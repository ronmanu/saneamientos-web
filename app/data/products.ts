...
export const products: Product[] = [
    ...
    {
        id: 'plato-roca-1',
        name: 'Plato Ducha Malta 120x80',
        brand: 'Roca',
        category: 'plato-ducha',
        price: 320,
        image: '/categories/platos-ducha.jpg',
        description: 'Plato de ducha modelo Malta extraplano. Medidas 120x80cm. Color blanco.',
        inStock: true,
        rarity: 2
    },
    {
        id: 'plato-roca-2',
        name: 'Plato Ducha Hall 100x70',
        brand: 'Roca',
        category: 'plato-ducha',
        price: 280,
        image: '/categories/platos-ducha.jpg',
        description: 'Plato de ducha Roca Hall. Antideslizante, acabado premium.',
        inStock: true,
        rarity: 3
    },
    {
        id: 'plato-gala-1',
        name: 'Plato Ducha Flex 140x70',
        brand: 'Gala',
        category: 'plato-ducha',
        price: 295,
        image: '/categories/platos-ducha.jpg',
        description: 'Plato extraplano Gala Flex. Resina con carga mineral.',
        inStock: true,
        rarity: 2
    },
    {
        id: 'plato-gala-2',
        name: 'Plato Ducha Cubic 90x90',
        brand: 'Gala',
        category: 'plato-ducha',
        price: 220,
        image: '/categories/platos-ducha.jpg',
        description: 'Plato cuadrado Gala Cubic. Ideal para duchas pequeñas.',
        inStock: false,
        rarity: 4
    },
    {
        id: 'plato-bellavista-1',
        name: 'Plato Ducha Class 120x70',
        brand: 'Bellavista',
        category: 'plato-ducha',
        price: 275,
        image: '/categories/platos-ducha.jpg',
        description: 'Plato Bellavista Class. Textura pizarra, muy resistente.',
        inStock: true,
        rarity: 3
    },
    {
        id: 'plato-bellavista-2',
        name: 'Plato Ducha Style 160x80',
        brand: 'Bellavista',
        category: 'plato-ducha',
        price: 380,
        image: '/categories/platos-ducha.jpg',
        description: 'Plato grande estilo piedra natural. Modelo descatalogado.',
        inStock: false,
        rarity: 5
    },
    {
        id: 'plato-jd-1',
        name: 'Plato Ducha Odeon Up 140x90',
        brand: 'Jacob Delafon',
        category: 'plato-ducha',
        price: 450,
        image: '/categories/platos-ducha.jpg',
        description: 'Plato premium Jacob Delafon Odeon Up. Diseño francés.',
        inStock: true,
        rarity: 4
    },
    {
        id: 'plato-jd-2',
        name: 'Plato Ducha Flight 100x80',
        brand: 'Jacob Delafon',
        category: 'plato-ducha',
        price: 395,
        image: '/categories/platos-ducha.jpg',
        description: 'Modelo Flight con válvula incluida. Superficie antideslizante.',
        inStock: true,
        rarity: 3
    },
    {
        id: 'plato-sangra-1',
        name: 'Plato Ducha Basic 120x80',
        brand: 'Sangrá',
        category: 'plato-ducha',
        price: 195,
        image: '/categories/platos-ducha.jpg',
        description: 'Plato económico Sangrá Basic. Relación calidad/precio excelente.',
        inStock: true,
        rarity: 1
    },
    {
        id: 'plato-sangra-2',
        name: 'Plato Ducha Compact 80x80',
        brand: 'Sangrá',
        category: 'plato-ducha',
        price: 165,
        image: '/categories/platos-ducha.jpg',
        description: 'Plato cuadrado compacto. Ideal para reformas.',
        inStock: true,
        rarity: 2
    }
];
